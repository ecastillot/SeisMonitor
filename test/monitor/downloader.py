...
from SeisMonitor.monitor.downloader.utils import DownloadRestrictions,Provider
...
sgc_rest = DownloadRestrictions(network="CM",
                    station="*",
                    location="*",
                    channel="*",
...
carma_rest = DownloadRestrictions(network="YU",
                    station="*",
                    location="*",
                    channel="H*",
